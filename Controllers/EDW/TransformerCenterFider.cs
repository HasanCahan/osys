...
namespace OlcuYonetimSistemi.Controllers.EDW
{
    ...
    public class TransformerCenterFider
    {
        [Serializable]
        ...
        public static DataSet ListTransformerCenterFider(Int32 startRowIndex, Int32 maximumRows, ListFilter filter)
        {
            Int32 tmp = Int32.MinValue;
            return ListTransformerCenterFider(startRowIndex, maximumRows, filter, ref tmp);
        }

        public static DataSet ListTransformerCenterFider(Int32 startRowIndex, Int32 maximumRows, String whereClause, ref Int32 totalRows, DbHelper.SQLFilterBuilder fb)
        {
            DataSet retval = null;
      ...
      ,tci.CityId  
	  ,tci.CityName 
  FROM dbo.NEW_TRANSFORMER_CENTER as tc 
  left join tCity tci on tci.CityId=tc.CITYID";
            ...
            string fetchSQL = String.Format("SELECT tBase.*, ROW_NUMBER() OVER(ORDER BY CityName, Name) As OrderRank FROM ({0}) AS tBase{1}", baseSQL,
               (String.IsNullOrEmpty(whereClause) ? String.Empty : " WHERE " + whereClause));
...
ORDER BY OrderRank", fetchSQL)))
        ...
        public static DataSet ListTransformerCenterFider(Int32 startRowIndex, Int32 maximumRows, ListFilter filter, ref Int32 totalRows)
        {
            ...
            return ListTransformerCenterFider(startRowIndex, maximumRows, whereClause, ref totalRows, fb);
        }
        public static DataSet ListTransformerCenterFider2(Int32 startRowIndex, Int32 maximumRows, ListFilter filter, ref Int32 totalRows)
        {
        ...
        public static EdwTransformerCenter GetTransformerCenterFider(Int32 id)
        {
...
SELECT tc.ID
  ...
  where Id=@Id"))
        ...
        public static DbHelper.DbResponse<EdwTransformerCenter> SaveTransformerCenterFider(EdwTransformerCenter item)
        {
            ...
            {
                sql = @"
UPDATE tEdw_TransformerCenterFider
   SET Name = @Name
      ,CityId=@CityId
      ,TownId = @TownId
      ,EdwNumber = @EdwNumber
...
";
            ...
            {
                sql = @"INSERT INTO tEdw_TransformerCenterFider
           (Name
           ,CityId
           ,TownId
           ,EdwNumber
     ...
     VALUES
        ...
        {
            int tmp = 0;
            var ds = ListTransformerCenterFider2(1, 3, filter, ref tmp);
