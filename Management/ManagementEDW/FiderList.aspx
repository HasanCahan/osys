<%@ Page Title="" Language="C#" MasterPageFile="~/Management/ManagementEDW/Management.Master" AutoEventWireup="true" CodeBehind="FiderList.aspx.cs" Inherits="OlcuYonetimSistemi.Management.ManagementEDW.FiderList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPage" runat="server">
        ...
        <div class="panel-body">
            ...
            <asp:DataGrid ID="grdPmum" runat="server" AutoGenerateColumns="false" AllowCustomPaging="true" CssClass="table table-striped" GridLines="None" UseAccessibleHeader="true">
                <Columns>
                    ...
                    <asp:BoundColumn DataField="Id" HeaderText="Fider-ID"></asp:BoundColumn>
                    ...
                    <asp:TemplateColumn HeaderText="">
                        <ItemTemplate>
                            ...
                            <asp:Button ID="btnDelete" runat="server" OnClick="btnDelete_Click" CommandArgument='<%#Eval("Id")%>' CssClass="btn btn-warning btn-sm" Text="Sil" OnClientClick="return confirm('Fider ve bağlı tüm kayıtlar silinecektir devam edilsin mi?')" />
                          --%>  <%} %>
                        </ItemTemplate>
                    </asp:TemplateColumn>
                </Columns>
    ...
    <div id="pnlFrameFider" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" onclick="closeModal(pnlFrameFider)" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
