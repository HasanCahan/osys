<%@ Page Title="" Language="C#" MasterPageFile="~/Management/ManagementEDW/Management.Master" AutoEventWireup="true" CodeBehind="FiderTransformerCenter.aspx.cs" Inherits="OlcuYonetimSistemi.Management.ManagementEDW.FiderTransformerCenter" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPage" runat="server">
    ...
    <asp:Panel ID="pnlAddEdit" runat="server" CssClass="modal fade" TabIndex="-1" role="dialog" >
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <asp:DropDownList ID="ddlCity" runat="server" CssClass="form-control" DataTextField="CityName" DataValueField="CityId" AutoPostBack="true" ></asp:DropDownList>
                                </div>
                            </div>
                            <%--    <div class="form-group">
