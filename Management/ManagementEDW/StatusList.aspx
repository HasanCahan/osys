<%@ Page Title="" Language="C#" MasterPageFile="~/Management/ManagementEDW/Management.Master" AutoEventWireup="true" CodeBehind="StatusList.aspx.cs" Inherits="OlcuYonetimSistemi.Management.ManagementEDW.StatusList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPage" runat="server">
    ...
    <h1 class="page-header">STATÜLER</h1>
    <div class="panel panel-default">
        <div class="panel-body">
            <p>
                <asp:Button ID="btnNew" runat="server" Text="Yeni Kayıt" CssClass="btn btn-primary" OnClick="btnNew_Click" />
            </p>
            <asp:DataGrid ID="grStatus" runat="server" AutoGenerateColumns="false" AllowCustomPaging="true" CssClass="table table-striped" GridLines="None" UseAccessibleHeader="true">
                <Columns>
                    <asp:BoundColumn DataField="OrderRank" HeaderText="#"></asp:BoundColumn>
                    <asp:BoundColumn DataField="Id" HeaderText="ID"></asp:BoundColumn>
                    <asp:BoundColumn DataField="Name" HeaderText="Statü Adı"></asp:BoundColumn>
                    <asp:TemplateColumn HeaderText="">
                        <ItemTemplate>
                            ...
                            <asp:Button ID="btnDelete" runat="server" OnClick="btnDelete_Click" CommandArgument='<%#Eval("Id")%>' CssClass="btn btn-warning btn-sm" Text="Sil" OnClientClick="return confirm('Statü silinecektir devam edilsin mi?')" />
                        </ItemTemplate>
                    </asp:TemplateColumn>
                </Columns>
            </asp:DataGrid>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-horizontal">
                            <div class="form-group">
                                <asp:Label ID="lblId" AssociatedControlID="txtId" runat="server" CssClass="col-sm-3 control-label">Statü ID</asp:Label>
                                <div class="col-sm-9">
