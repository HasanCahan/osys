...
{
    public partial class TransformerTypeList : System.Web.UI.Page
    {
        ...
        private void ListTransformerType()
        {
            grTransformerType.DataSource = TransformerType.ListTransformerType();
            grTransformerType.DataBind();
        }
        ...
        protected void btnChange_Click(object sender, EventArgs e)
        {
            ...
            var item = TransformerType.GetTransformerType(Convert.ToInt32(btnChange.CommandArgument.Trim()));
            if (item != null)
            {
        ...
        protected void btnSaveChanges_Click(object sender, EventArgs e)
        {
            ...
            {
                ucAlert.Text = "Pmum Tip Adı girmelisiniz.";
                txtName.Focus();
                return;
            }

            EdwTransformerType statu = new EdwTransformerType()
            {
                Id = btnSave.CommandName == "A" ? 0 : Convert.ToInt32(btnSave.CommandArgument),
                Name = txtName.Text
            };

            OlcuYonetimSistemi.DbHelper.DbResponse<EdwTransformerType> saveResp = TransformerType.SaveTransformerType(statu);
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            OlcuYonetimSistemi.DbHelper.DbResponse resp = TransformerType.DeleteTransformerType(Convert.ToInt32(btnDelete.CommandArgument.Trim()));
        ...
        protected string GetTransformerTypeUrl(int statusId)
        {
            UriBuilder uri = new UriBuilder(new Uri(Page.Request.Url, Page.ResolveUrl("~/Management/ManagementEDW/TransformerTypeList.aspx")));
            uri.Query = "Id=" + statusId.ToString();
            return uri.ToString();
        }
