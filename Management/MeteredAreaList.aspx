<%@ Page Title="" Language="C#" MasterPageFile="~/Management/Management.Master" AutoEventWireup="true" CodeBehind="MeteredAreaList.aspx.cs" Inherits="OlcuYonetimSistemi.Management.MeteredAreaList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPage" runat="server">
    <%if (!IsSelectMode)
      { %><h1 class="page-header">Ölçüm Sahaları</h1>
    <%} %>
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <asp:DataGrid ID="grMeteredArea" runat="server" AutoGenerateColumns="false" AllowCustomPaging="true" CssClass="table table-striped" GridLines="None" UseAccessibleHeader="true">
                <Columns>
                    <asp:BoundColumn DataField="OrderRank" HeaderText="#"></asp:BoundColumn>
                    <asp:BoundColumn DataField="MeteredAreaId" HeaderText="Saha No"></asp:BoundColumn>
                    ...
                    <asp:BoundColumn DataField="AreaName" HeaderText="Adı"></asp:BoundColumn>
                    <asp:BoundColumn DataField="Description" HeaderText="Açıklama"></asp:BoundColumn>
                    <asp:TemplateColumn HeaderText="">
                        <ItemTemplate>
                            <%if (IsSelectMode)
                              {%>
                            <asp:Button ID="btnSelectItem" runat="server" OnClick="btnSelectItem_Click" CommandArgument='<%#Eval("MeteredAreaId")%>' CssClass="btn btn-primary btn-sm" Text="Seç" />
                            <%}
                              else
                              { %>
                            <a href="<%#GetMeterPointUrl((int)Eval("MeteredAreaId"))%>" class="btn btn-default btn-sm">Ölçüm Noktaları</a>
                            <asp:Button ID="btnChange" runat="server" OnClick="btnChange_Click" CommandArgument='<%#Eval("MeteredAreaId")%>' CssClass="btn btn-primary btn-sm" Text="Değiştir" />
                            <asp:Button ID="btnDelete" runat="server" OnClick="btnDelete_Click" CommandArgument='<%#Eval("MeteredAreaId")%>' CssClass="btn btn-warning btn-sm" Text="Sil" OnClientClick="return confirm('Ölçüm Sahası ve bağlı tüm kayıtlar silinecektir devam edilsin mi?')" />
                            <%} %>
                        </ItemTemplate>
                    </asp:TemplateColumn>
                </Columns>
                ...
                <ContentTemplate>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-horizontal">
                            <div class="form-group">
                                <asp:Label AssociatedControlID="txtMeteredAreaId" runat="server" CssClass="col-sm-3 control-label">Saha No</asp:Label>
                                <div class="col-sm-9">
                                    <asp:TextBox ID="txtMeteredAreaId" runat="server" CssClass="form-control" placeholder="Sistem Üretir" ReadOnly="true"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <asp:Label AssociatedControlID="ddlCity" runat="server" CssClass="col-sm-3 control-label">Şehir</asp:Label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                <asp:Label AssociatedControlID="txtAreaName" runat="server" CssClass="col-sm-3 control-label">Saha Adı</asp:Label>
                                <div class="col-sm-9">
